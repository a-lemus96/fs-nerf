...
def config_parser() -> argparse.Namespace:
    ...
    parser.add_argument(
            '--model', choices=['nerf', 'sinerf', 'ensemble', 'sires'], 
            default='nerf', help='Model to be used for training'
    )
    parser.add_argument(
    ...
    parser.add_argument(
            '--func', choices=['linear', 'exp'], default='linear',
            help='Occlusion regularization base function'
    )
    parser.add_argument(
